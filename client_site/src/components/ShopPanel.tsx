            ...
            <div className={`shop-container`}>
                <div className="shop-nav">
                    <div className="nav-category-container">
                        <a
                            className={`nav-category ${isTheme ? 'nav-category-toggled' : ''}`}
                        ...
                        <a
                            className={`nav-category ${isBanner ? 'nav-category-toggled' : ''}`}
                ...
                <div className={`center-theme ${isTheme ? '' : 'hide'}`}>
                    ...
                    <div className="coming-soon">Work in progress, full implementation coming soon!</div>
                </div>
