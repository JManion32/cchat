...
QWidget* Client::buildChatScreen()
{
    ...
    connect(shopButton, &QPushButton::clicked, [this]() { stack->setCurrentIndex(2); });
...
QWidget* Client::buildShopScreen()
{
    ...
    connect(returnButton, &QPushButton::clicked, [this]() { stack->setCurrentIndex(1); });
    ...
    for (int i = 0; i < (int)themes.size(); i++)
    {
        ...
        img->setPixmap(pix.scaled(180, 180, Qt::KeepAspectRatio, Qt::SmoothTransformation));
